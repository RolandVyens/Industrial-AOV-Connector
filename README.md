...
**The current custom path tag feature needs to be modified due to format compatibility issues with Blender's official variables, which are causing functionality problems.**
